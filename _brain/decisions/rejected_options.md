...
[SCOPE] → Carrying the existing SQLite prototype forward as the base for MTS v2.0
Rejected: 2026-07-19
Reason: Prototype uses SQLite and its own README.txt frames it as a disposable "before deciding what to carry into ELTS" test build; MTS v2.0 spec is MySQL/PDO from the ground up
