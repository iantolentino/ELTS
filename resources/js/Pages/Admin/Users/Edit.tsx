...
export default function UserEdit({ user, roles, teams, departments }: Props) {
        ...
        <AppLayout>
            ...
            <div className="p-6 max-w-2xl space-y-5">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-semibold text-[--color-text]">Edit User</h1>
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <Card header={<span className="text-sm font-semibold">Account Settings</span>}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-1">
                                <label className="text-sm font-medium text-[--color-text]">Availability</label>
                                <select value={form.data.availability_status} onChange={e => form.setData('availability_status', e.target.value as AvailabilityStatus)} className={selectCls}>
                    ...
                    <Card header={<span className="text-sm font-semibold">Security &amp; Access</span>}>
                        <p className="text-xs text-[--color-text-muted] mb-3">Leave password blank to keep the current password.</p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1">
                                <label className="text-sm font-medium text-[--color-text]">New password</label>
                                <div className="relative">
                                    <input type={showPw ? 'text' : 'password'} value={form.data.password} onChange={e => form.setData('password', e.target.value)} autoComplete="new-password"
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="relative">
                                    <input type={showCon ? 'text' : 'password'} value={form.data.password_confirmation} onChange={e => form.setData('password_confirmation', e.target.value)} autoComplete="new-password"
